...
async def main():
    ...
    while title:
        ...
        text("Made with Pygame and Pyodide", 250, 300, 30, 255, 255, 255)
        text("Repo: https://github.com/nanoticity/snake", 190, 400, 30, 255, 255, 255)
        text("For High Seas 2024-2025", 275, 750, 30, 255, 255, 255)
